...
SRCS = $(SRCS_DIR)/main.cpp $(SRCS_DIR)/ConfigParser.cpp $(SRCS_DIR)/Config.cpp $(SRCS_DIR)/Utils.cpp $(SRCS_DIR)/Location.cpp $(SRCS_DIR)/Server.cpp $(SRCS_DIR)/RequestParser.cpp $(SRCS_DIR)/ErrorResponse.cpp $(SRCS_DIR)/CGIRunner.cpp $(SRCS_DIR)/CacheManager.cpp $(SRCS_DIR)/MimeTypes.cpp
